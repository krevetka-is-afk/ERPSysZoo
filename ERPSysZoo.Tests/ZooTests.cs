...
namespace ERPSysZoo.ERPSysZoo.Tests;
...
public class ContactZooTests
{
    ...
    public void ContactZoo_ShouldHaveCorrectAnimals()
    {
        ...
        Assert.NotEmpty(contactZooAnimals);
        Assert.Contains(rabbit, contactZooAnimals);
        Assert.DoesNotContain(monkey, contactZooAnimals);
        Assert.DoesNotContain(leo, contactZooAnimals);
